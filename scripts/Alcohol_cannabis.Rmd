...
>Used data fields 20404-0.0 and 20406-0.0 from MHQ1 ("Ever physically dependent on alcohol", "Ever addicted to alcohol" alcohol drinker status = never. (-3) Prefer not to answer, (0) Never, (1) Previous, (2) Current
> is.na('20404-0.0') | '20404-0.0' != 1
> is.na('20406-0.0') | '20406-0.0' != 1 
...
dat <- dat %>%
  mutate(
    MHQ2.AlcoholHazardousHarmfulUseControl = case_when(
      MHQ2.AUDITScore < 8 &
        (
	  is.na(`20404-0.0`) |
	    `20404-0.0` != 1
