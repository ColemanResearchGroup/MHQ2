...
##Sum of UCLA scores
MHQ2$UCLA_loneliness_sum <- rowSums(
  MHQ2[,c("29172-0.0_recoded_social","29173-0.0_recoded_social","29174-0.0_recoded_social")],
  na.rm = FALSE
)

MHQ2 <- MHQ2[,!grepl("_recoded_social$",colnames(MHQ2))]
