...
This requires that the algorithm generating code (i.e. Overarching.R) for the same has already been run.
...
THIS ASSUMES THE ALGORITHM SCRIPT HAS BEEN RUN!

Modify the script so that:
    - Data from the wider UK Biobank and MHQ1 is passed to Full_Data
    - Data from the original MHQ2 (i.e. the input to the algorithm script) is passed to MHQ2_Raw
    - The derived data from the algorithm script is passed to MHQ2_Derived


```{r Read in data}

Full_Data <- readRDS("/path/to/UKBB_Baseline_MHQ1.rds")
MHQ2_Raw <- readRDS("/path/to/UKBB_MHQ2_Raw.rds")
MHQ2_Derived <- readRDS("/path/to/UKBB/MHQ2_Derived.rds")
...
This needs to be modify to pass the latest withdrawals list from UK Biobank

```{r Nix latest withdrawls}

Withdrawals <- fread("/path/to/withdrawXXXXX_XXX_2024XXXX.txt", head=F, data.table=F)
...
## Remove people with missing ages
...
cat(
  ...
  "(NoneOfTheAbove, Other, GCSE, ALevel, Degree)",
  "\t"
) #MHQ2
...
cat(
  ...
  "(OwnOutright, OwnMortgage, RentSocial, RentPrivate, Other)",
  "\t"
) #MHQ2
...
cat(
  "Physical activity at least three times a week\tNA",
  "\t"
)
...
Full_Data_MHQ2_Female <-  Full_Data_MHQ2[Full_Data_MHQ2$UKB.Sex == "Female", ]

sink("Table2_Female.txt")
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ2.Age.Bands
  )[1],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ1.Age.Bands
  )[1],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$UKB.Age.Bands
  )[1],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ2.Sex
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ1.Sex
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ2.Ethnicity
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ1.Ethnicity
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$UKB.Ethnicity
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ2.TDI
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ1.TDI
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ2.Highest.Qualification
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ1.Highest.Qualification
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$UKB.Highest.Qualification
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ2.Housing
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ1.Housing
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$UKB.Housing
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ2.Longstanding.Illness
  )[2],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ1.Longstanding.Illness
  )[2],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$UKB.Longstanding.Illness
  )[2],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ2.Smoking
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ1.Smoking
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$UKB.Smoking
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ2.Physical.Activity
  )[2],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$MHQ1.Physical.Activity
  )[2],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Female$UKB.Physical.Activity
  )[2],
  paste(
    round(
      prop.table(
...
cat(
  mean(
    Full_Data_MHQ2_Female$MHQ2.Neuroticism,
    na.rm=T
  ),
  "(",
  sd(
...
cat(
  mean(
    Full_Data_MHQ2_Female$MHQ1.Neuroticism,
    na.rm=T
  ),
  "(",
  sd(
...
cat(
  mean(
    Full_Data_MHQ2_Female$UKB.Neuroticism,
    na.rm=T
  ),
  "(",
  sd(
...
rm(Full_Data_MHQ2_Female)

sink("Table2_Male.txt")

Full_Data_MHQ2_Male <- Full_Data_MHQ2[Full_Data_MHQ2$UKB.Sex == "Male",
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ2.Age.Bands
  )[1],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ1.Age.Bands
  )[1],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$UKB.Age.Bands
  )[1],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ2.Ethnicity
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ1.Ethnicity
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$UKB.Ethnicity
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ2.Highest.Qualification
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ1.Highest.Qualification
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$UKB.Highest.Qualification
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ2.Housing
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ1.Housing
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$UKB.Housing
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ2.Longstanding.Illness
  )[2],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ1.Longstanding.Illness
  )[2],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$UKB.Longstanding.Illness
  )[2],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ2.Smoking
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ1.Smoking
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$UKB.Smoking
  ),
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ2.Physical.Activity
  )[2],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$MHQ1.Physical.Activity
  )[2],
  paste(
    round(
      prop.table(
...
cat(
  table(
    Full_Data_MHQ2_Male$UKB.Physical.Activity
  )[2],
  paste(
    round(
      prop.table(
...
cat(
  mean(
    Full_Data_MHQ2_Male$MHQ2.Neuroticism,
    na.rm=T
  ),
  "(",
  sd(
...
cat(
  mean(
    Full_Data_MHQ2_Male$MHQ1.Neuroticism,
    na.rm=T
  ),
  "(",
  sd(
...
cat(
  mean(
    Full_Data_MHQ2_Male$UKB.Neuroticism,
    na.rm=T
  ),
  "(",
  sd(
...
rm(Full_Data_MHQ2_Male)

```

# Define additional fields

```{r DefineAdditionalFields}

Full_Data_MHQ2$MHQ2.AnyFullThresholdEatingDisorder <- with(Full_Data_MHQ2,
  case_when(
    (
      !is.na(MHQ2.AnorexiaNervosa) &
        MHQ2.AnorexiaNervosa == 1
    ) |
    (
      !is.na(MHQ2.BulimiaNervosa) &
        MHQ2.BulimiaNervosa == 1
    ) |
    (
      !is.na(MHQ2.BingeEatingDisorderDSM5) &
        MHQ2.BingeEatingDisorderDSM5 == 1
    ) |
    (
      !is.na(MHQ2.PurgingDisorder) &
...
Full_Data_MHQ2$MHQ2.NoLifetimeDisorder <- with(Full_Data_MHQ2,
  case_when(
    (
    ...
    (
      !is.na(MHQ2.PanicDisorder) &
      	MHQ2.PanicDisorder == 1
    ) |
    (
      !is.na(MHQ2.AnyFullThresholdEatingDisorder) &
      	MHQ2.AnyFullThresholdEatingDisorder == 1
    ) ~ 0,
    is.na(MHQ2_Completed) ~ NA_real_,
    TRUE ~ 1
  )
)
...
Table_3 <- function(data){
  ...
  cat(
    table(
      data$MHQ2.Age.Bands,
      data$MHQ2.AnyFullThresholdEatingDisorder
    ),
    "\t"
  ) # Eating disorders
  ...
  cat(
    median(
      data[data$MHQ2_Completed == 1, "MHQ2.Age"],
      na.rm = TRUE
    ),
    "\t"
  ) # MHQ2
  ...
  cat(
    median(
      data[data$MHQ2.NoLifetimeDisorder == 1, "MHQ2.Age"],
      na.rm = TRUE
    ),
    "\t"
  ) # No Criteria
  ...
  cat(
    median(
      data[data$MHQ2.DepressionEverCase == 1, "MHQ2.Age"],
      na.rm = TRUE
    ),
    "\t"
  ) # Depression
  ...
  cat(
    median(
      data[data$MHQ2.PanicDisorder == 1, "MHQ2.Age"],
      na.rm = TRUE
    ),
    "\t"
  ) # Panic disorder
  ...
  cat(
    median(
      data[data$MHQ2.AnyFullThresholdEatingDisorder == 1, "MHQ2.Age"],
      na.rm = TRUE
    ),
    "\t"
  ) # Eating disorder
  ...
  cat(
    table(
      data$MHQ2.Sex, data$MHQ2.NoLifetimeDisorder
    ),
    "\t"
  ...
  cat(
    table(
      data$MHQ2.Sex, data$MHQ2.DepressionEverCase
    ),
    "\t"
  ) # Depression
  ...
  cat(
    table(
      data$MHQ2.Sex, data$MHQ2.PanicDisorder
    ),
    "\t"
  ) # Panic disorder
  ...
  cat(
    table(
      data$MHQ2.Sex, data$MHQ2.AnyFullThresholdEatingDisorder
    ),
    "\t"
  ) # Eating disorder
  ...
  cat(
    table(
      data$MHQ2.Ethnicity, data$MHQ2.NoLifetimeDisorder
    ),
    "\t"
  ) # No Lifetime Criteria
  ...
  cat(
    table(
      data$MHQ2.Ethnicity, data$MHQ2.DepressionEverCase
    ),
    "\t"
  ) # Depression
  ...
  cat(
    table(
      data$MHQ2.Ethnicity, data$MHQ2.BD1
    ),
    "\t"
  ) # Bipolar I
  ...
  cat(
    table(
      data$MHQ2.Ethnicity, data$MHQ2.PanicDisorder
    ),
    "\t"
  ) # Panic disorder
  ...
  cat(
    table(
      data$MHQ2.Ethnicity, data$MHQ2.AnyFullThresholdEatingDisorder
    ),
    "\t"
  ) # Eating disorder
  ...
  cat(
    mean(
      data[data$MHQ2.NoLifetimeDisorder == 1, 
	"MHQ2.Neuroticism"], 
      na.rm=T
    ), 
    "\t",
  ...
  cat(
    mean(
      data[data$MHQ2.DepressionEverCase == 1, 
	"MHQ2.Neuroticism"], 
      na.rm=T
    ), 
    "\t",
  ...
  cat(
    mean(
      data[data$MHQ2.PanicDisorder == 1, 
	"MHQ2.Neuroticism"], 
      na.rm=T
    ), 
    "\t",
  ...
  cat(
    mean(
      data[data$MHQ2.AnyFullThresholdEatingDisorder == 1,
	"MHQ2.Neuroticism"],
      na.rm=T
    ),
    "\t",
  ...
  cat(
    quantile(
      data[!is.na(data$MHQ2.NoLifetimeDisorder) & data$MHQ2.NoLifetimeDisorder == 1,"MHQ2.UCLALoneliness"],
      prob=c(0,0.25,0.5,0.75,1),
      na.rm=TRUE
    ),
    "\t"
  ...
  cat(
    quantile(
      data[!is.na(data$MHQ2.DepressionEverCase) & data$MHQ2.DepressionEverCase == 1,"MHQ2.UCLALoneliness"],
      prob=c(0,0.25,0.5,0.75,1),
      na.rm=TRUE
    ), 
    "\t"
  ...
  cat(
    quantile(
      data[!is.na(data$MHQ2.BD1) & data$MHQ2.BD1 == 1,"MHQ2.UCLALoneliness"],
      prob=c(0,0.25,0.5,0.75,1),
      na.rm=TRUE
    ), 
    "\t"
  ...
  cat(
    quantile(
      data[!is.na(data$MHQ2.PanicDisorder) & data$MHQ2.PanicDisorder == 1,"MHQ2.UCLALoneliness"],
      prob=c(0,0.25,0.5,0.75,1),
      na.rm=TRUE
    ), 
    "\t"
  ...
  cat(
    quantile(
      data[!is.na(data$MHQ2.AnyFullThresholdEatingDisorder) & data$MHQ2.AnyFullThresholdEatingDisorder == 1,"MHQ2.UCLALoneliness"],
      prob=c(0,0.25,0.5,0.75,1),
      na.rm=TRUE
    ),
    "\t"
  ...
  cat(
    table(
      data$MHQ2.BriefResilienceScale < 3, 
      data$MHQ2_Completed
    ), 
    "\t"
  ) # MHQ2
  ...
  ## Item is 29155-0.0
  ## Need to remove missing values -3 Prefer not to answer

  data[,"29155-0.0"] <- case_when(
    data[,"29155-0.0"] < 0 ~ NA_real_,
    TRUE ~ data[,"29155-0.0"]
  )
  ...
  cat(
    quantile(
      data[!is.na(data$MHQ2.NoLifetimeDisorder) & data$MHQ2.NoLifetimeDisorder == 1,"29155-0.0"],
      prob=c(0,0.25,0.5,0.75,1),
      na.rm=TRUE
    ),
    "\t"
  ...
  cat(
    quantile(
      data[!is.na(data$MHQ2.DepressionEverCase) & data$MHQ2.DepressionEverCase == 1,"29155-0.0"],
      prob=c(0,0.25,0.5,0.75,1),
      na.rm=TRUE
    ), 
    "\t"
  ...
  cat(
    quantile(
      data[!is.na(data$MHQ2.BD1) & data$MHQ2.BD1 == 1,"29155-0.0"],
      prob=c(0,0.25,0.5,0.75,1),
      na.rm=TRUE
    ), 
    "\t"
  ...
  cat(
    quantile(
      data[!is.na(data$MHQ2.PanicDisorder) & data$MHQ2.PanicDisorder == 1,"29155-0.0"],
      prob=c(0,0.25,0.5,0.75,1),
      na.rm=TRUE
    ), 
    "\t"
  ...
  cat(
    quantile(
      data[!is.na(data$MHQ2.AnyFullThresholdEatingDisorder) & data$MHQ2.AnyFullThresholdEatingDisorder == 1,"29155-0.0"],
      prob=c(0,0.25,0.5,0.75,1),
      na.rm=TRUE
    ),
    "\t"
...
Binge-eating ever case -- ALTERNATIVE PLOT


```{r Figure 5}


Data_For_Upset <- with(Full_Data_MHQ2,
  Full_Data_MHQ2[!is.na(MHQ2_Completed) &
    MHQ2_Completed == 1,
    c("eid",
...
Data_For_Upset_Alt <- with(Full_Data_MHQ2,
  Full_Data_MHQ2[!is.na(MHQ2_Completed) &
    MHQ2_Completed == 1,
    c("eid",
      "MHQ2.DepressionEverCase",
...
na2zero(Data_For_Upset)
na2zero(Data_For_Upset_Alt)
...
Full_Data_MHQ2$MHQ1.PHQ9.Derived.Depression<-with(Full_Data_MHQ2, ifelse(MHQ1.PHQ9.No.Info == 1, NA,
				 ifelse(!is.na(MHQ1.PHQ9.Severity) & MHQ1.PHQ9.Severity < 5, 0,
				 ifelse(!is.na(MHQ1.PHQ9.Screen) & MHQ1.PHQ9.Screen == 1 &
				        !is.na(MHQ1.PHQ9.Items) & MHQ1.PHQ9.Items > 4, 1, 0))))
...
Full_Data_MHQ2$MHQ1.GAD7.Derived.Anxiety <- with(Full_Data_MHQ2, ifelse(is.na(MHQ1.GAD7.Severity), NA,
                           ifelse(MHQ1.GAD7.Severity > 9, 1, 0)))
...
Full_Data_MHQ2$MHQ1.Alcohol.Use.Disorder.Harmful<-with(Full_Data_MHQ2, ifelse(MHQ1.AUDIT.Score > 15, 1,
                                    ifelse(!is.na(`20404-0.0`) & `20404-0.0` == 1, NA,
                                    ifelse((!is.na(`20414-0.0`) & `20414-0.0` == 0) |
                                           (!is.na(`20403-0.0`) & `20403-0.0` == 1 &
                                            !is.na(`20416-0.0`) & `20416-0.0` == 1 &
...
## Restrict Table6 to those who did both questionnaires

Full_Data_MHQ2_Table_6 <- Full_Data_MHQ2[!is.na(Full_Data_MHQ2$MHQ2_Completed) & !is.na(Full_Data_MHQ2$`20400-0.0`), ]

# UKB

Full_Data_MHQ2_Table_6$UKB.Age.Bands.Table6 <- define_age_bands_table_6(
  data = Full_Data_MHQ2_Table_6,
  age.variable = "UKB.Age"
)

# MHQ1

Full_Data_MHQ2_Table_6$MHQ1.Age.Bands.Table6 <- define_age_bands_table_6(
  data = Full_Data_MHQ2_Table_6,
  age.variable = "MHQ1.Age"
)
...
Full_Data_MHQ2_Table_6$MHQ2.Age.Bands.Table6 <- define_age_bands_table_6(
  data = Full_Data_MHQ2_Table_6,
  age.variable = "MHQ2.Age"
)
...
with(Full_Data_MHQ2_Table_6, table(MHQ1.Age.Bands.Table6, MHQ1.PHQ9.Derived.Depression, MHQ1.Sex, useNA="a"))

cat("## PHQ9 2022\n")

with(Full_Data_MHQ2_Table_6, table(MHQ2.Age.Bands.Table6, MHQ2.PHQ9DerivedDepression, MHQ2.Sex, useNA="a"))

cat("## GAD7 2016\n")

with(Full_Data_MHQ2_Table_6, table(MHQ1.Age.Bands.Table6, MHQ1.GAD7.Derived.Anxiety, MHQ1.Sex, useNA="a"))

cat("## GAD7 2022\n")

with(Full_Data_MHQ2_Table_6, table(MHQ2.Age.Bands.Table6, MHQ2.GADDerivedAnxiety, MHQ2.Sex, useNA="a"))

cat("## AUDIT 2016\n")

with(Full_Data_MHQ2_Table_6, table(MHQ1.Age.Bands.Table6, MHQ1.Alcohol.Use.Disorder.Harmful, MHQ1.Sex, useNA="a"))

cat("## AUDIT 2022\n")

with(Full_Data_MHQ2_Table_6, table(MHQ2.Age.Bands.Table6, MHQ2.AlcoholHarmfulDrinking, MHQ2.Sex, useNA="a"))
...
```{r Define age of onset}

## MDD

# Clean depression age at onset variable (29034)

Full_Data_MHQ2_Table_6$f29034.0.0_clean <- ifelse(Full_Data_MHQ2_Table_6$`29034-0.0` < 0 | is.na(Full_Data_MHQ2_Table_6$`29034-0.0`), NA, Full_Data_MHQ2_Table_6$`29034-0.0`)

# Define date of first episode

Full_Data_MHQ2_Table_6$ApproxDateFirstDepEpisode <- with(Full_Data_MHQ2_Table_6,
  case_when(
    is.na(Full_Data_MHQ2_Table_6$`29198-0.0`) |
      is.na(MHQ2.Age) |
      is.na(Full_Data_MHQ2_Table_6$f29034.0.0_clean) ~ NA,
    .default=as.Date(
      as.Date(Full_Data_MHQ2_Table_6$`29198-0.0`) -
      as.difftime(
        (
	  MHQ2.Age -
	    Full_Data_MHQ2_Table_6$f29034.0.0_clean
	)*365.25,
	unit="days"
      )
    )
...
# Define incident depression

Full_Data_MHQ2_Table_6$IncidentDepression <- with(Full_Data_MHQ2_Table_6,
  case_when(
...
# Clean bipolar age at onset variable (29053)

Full_Data_MHQ2_Table_6$f29053.0.0_clean <- ifelse(Full_Data_MHQ2_Table_6$`29053-0.0` < 0 | is.na(Full_Data_MHQ2_Table_6$`29053-0.0`), NA, Full_Data_MHQ2_Table_6$`29053-0.0`)

# Define date of first episode

Full_Data_MHQ2_Table_6$ApproxDateFirstManicEpisode <- with(Full_Data_MHQ2_Table_6,
  case_when(
    is.na(Full_Data_MHQ2_Table_6$`29199-0.0`) |
      is.na(MHQ2.Age) |
      is.na(Full_Data_MHQ2_Table_6$f29053.0.0_clean) ~ NA,
    .default=as.Date(
      as.Date(Full_Data_MHQ2_Table_6$`29199-0.0`) -
      as.difftime(
        (
	  MHQ2.Age -
	    Full_Data_MHQ2_Table_6$f29053.0.0_clean
	)*365.25,
	unit="days"
      )
    )
...
# Define incident bipolar

Full_Data_MHQ2_Table_6$IncidentBipolar <- with(Full_Data_MHQ2_Table_6,
  case_when(
    is.na(ApproxDateFirstDepEpisode) &
      is.na(ApproxDateFirstManicEpisode) ~ NA,
    (is.na(ApproxDateFirstManicEpisode) &
      !is.na(ApproxDateFirstDepEpisode) &
      ApproxDateFirstDepEpisode > as.Date("2016-07-13")
    ) |
    (is.na(ApproxDateFirstDepEpisode) &
      !is.na(ApproxDateFirstManicEpisode) &
      ApproxDateFirstManicEpisode > as.Date("2016-07-13")
    ) |
    (!is.na(ApproxDateFirstManicEpisode) &
      !is.na(ApproxDateFirstDepEpisode) &
      ApproxDateFirstDepEpisode > ApproxDateFirstManicEpisode &
      ApproxDateFirstManicEpisode > as.Date("2016-07-13")
    ) |
        (!is.na(ApproxDateFirstManicEpisode) &
      !is.na(ApproxDateFirstDepEpisode) &
      ApproxDateFirstManicEpisode > ApproxDateFirstDepEpisode &
      ApproxDateFirstDepEpisode > as.Date("2016-07-13")
    ) ~ 1,
    .default = 0
  )
...
# Clean self harm age at onset variable (29112)

Full_Data_MHQ2_Table_6$f29112.0.0_clean <- ifelse(Full_Data_MHQ2_Table_6$`29112-0.0` < 0 | is.na(Full_Data_MHQ2_Table_6$`29112-0.0`), NA, Full_Data_MHQ2_Table_6$`29112-0.0`)

# Define date of first episode

Full_Data_MHQ2_Table_6$ApproxDateFirstHarmEpisode <- with(Full_Data_MHQ2_Table_6,
  case_when(
    is.na(Full_Data_MHQ2_Table_6$`29204-0.0`) |
      is.na(MHQ2.Age) |
      is.na(Full_Data_MHQ2_Table_6$f29112.0.0_clean) ~ NA,
    .default=as.Date(
      as.Date(Full_Data_MHQ2_Table_6$`29204-0.0`) -
      as.difftime(
        (
	  MHQ2.Age -
	    Full_Data_MHQ2_Table_6$f29112.0.0_clean
	)*365.25,
	unit="days"
      )
    )
...
# Define incident self harm

Full_Data_MHQ2_Table_6$IncidentHarm <- with(Full_Data_MHQ2_Table_6,
  case_when(
    is.na(ApproxDateFirstHarmEpisode) ~ NA,
    ApproxDateFirstHarmEpisode > as.Date("2016-07-13") ~ 1,
    .default = 0
  )
)
...
# Clean cannabis age at onset variable (29105)

Full_Data_MHQ2_Table_6$f29105.0.0_clean <- ifelse(Full_Data_MHQ2_Table_6$`29105-0.0` < 0 | is.na(Full_Data_MHQ2_Table_6$`29105-0.0`), NA, Full_Data_MHQ2_Table_6$`29105-0.0`)

# Define date of first episode 

Full_Data_MHQ2_Table_6$ApproxDateFirstCanEpisode <- with(Full_Data_MHQ2_Table_6,
  case_when(
    is.na(Full_Data_MHQ2_Table_6$`29203-0.0`) |
      is.na(MHQ2.Age) |
      is.na(Full_Data_MHQ2_Table_6$f29105.0.0_clean) ~ NA,
    .default=as.Date(
      as.Date(Full_Data_MHQ2_Table_6$`29203-0.0`) -
      as.difftime(
        (
	  MHQ2.Age -
	    Full_Data_MHQ2_Table_6$f29105.0.0_clean
	)*365.25,
	unit="days"
      )
    )
...
# Define incident cannabis use

Full_Data_MHQ2_Table_6$IncidentCannabis <- with(Full_Data_MHQ2_Table_6,
  case_when(
    is.na(ApproxDateFirstCanEpisode) ~ NA,
    ApproxDateFirstCanEpisode > as.Date("2016-07-13") ~ 1,
    .default = 0
  )
)
...
cat("## MDD\n")
cat("# MHQ2 (Rows) vs MHQ1 (Columns)\n")
print(with(Full_Data_MHQ2_Table_6, table(!is.na(MHQ2.DepressionEverCase) & MHQ2.DepressionEverCase == 1, !is.na(MHQ1.Depressed.Ever) & MHQ1.Depressed.Ever == 1, useNA="a")))

print(
  with(
    Full_Data_MHQ2_Table_6[
      !is.na(Full_Data_MHQ2_Table_6$MHQ2.DepressionEverCase) &
	Full_Data_MHQ2_Table_6$MHQ2.DepressionEverCase == 1 &
	(
	  is.na(Full_Data_MHQ2_Table_6$MHQ1.Depressed.Ever) |
	  (
	    !is.na(Full_Data_MHQ2_Table_6$MHQ1.Depressed.Ever) &
	      Full_Data_MHQ2_Table_6$MHQ1.Depressed.Ever == 0
	  )
	),
    ],
    table(IncidentDepression, useNA="a")
  )
)

cat("# Female\n")

print(with(Full_Data_MHQ2_Table_6[Full_Data_MHQ2_Table_6$MHQ2.Sex == "Female", ], table(!is.na(MHQ2.DepressionEverCase) & MHQ2.DepressionEverCase == 1, !is.na(MHQ1.Depressed.Ever) & MHQ1.Depressed.Ever == 1, useNA="a")))

print(
  with(
    Full_Data_MHQ2_Table_6[
      Full_Data_MHQ2_Table_6$MHQ2.Sex == "Female" &
      !is.na(Full_Data_MHQ2_Table_6$MHQ2.DepressionEverCase) &
	Full_Data_MHQ2_Table_6$MHQ2.DepressionEverCase == 1 &
	(
	  is.na(Full_Data_MHQ2_Table_6$MHQ1.Depressed.Ever) |
...
print(with(Full_Data_MHQ2_Table_6[Full_Data_MHQ2_Table_6$MHQ2.Sex == "Male", ], table(!is.na(MHQ2.DepressionEverCase) & MHQ2.DepressionEverCase == 1, !is.na(MHQ1.Depressed.Ever) & MHQ1.Depressed.Ever == 1, useNA="a")))

print(
  with(
    Full_Data_MHQ2_Table_6[
      Full_Data_MHQ2_Table_6$MHQ2.Sex == "Male" &
      !is.na(Full_Data_MHQ2_Table_6$MHQ2.DepressionEverCase) &
	Full_Data_MHQ2_Table_6$MHQ2.DepressionEverCase == 1 &
	(
	  is.na(Full_Data_MHQ2_Table_6$MHQ1.Depressed.Ever) |
...
cat("## Bipolar\n")
cat("# MHQ2 (Rows) vs MHQ1 (Columns)\n")
print(with(Full_Data_MHQ2_Table_6, table(!is.na(MHQ2.BD1) & MHQ2.BD1 == 1, !is.na(MHQ1.BPDI) & MHQ1.BPDI == 1, useNA="a")))

print(
  with(
    Full_Data_MHQ2_Table_6[
      !is.na(Full_Data_MHQ2_Table_6$MHQ2.BD1) &
	Full_Data_MHQ2_Table_6$MHQ2.BD1 == 1 &
	(
	  is.na(Full_Data_MHQ2_Table_6$MHQ1.BPDI) |
	  (
	    !is.na(Full_Data_MHQ2_Table_6$MHQ1.BPDI) &
	      Full_Data_MHQ2_Table_6$MHQ1.BPDI == 0
	  )
	),
    ],
    table(IncidentBipolar, useNA="a")
  )
)

cat("# Female\n")

print(with(Full_Data_MHQ2_Table_6[Full_Data_MHQ2_Table_6$MHQ2.Sex == "Female", ], table(!is.na(MHQ2.BD1) & MHQ2.BD1 == 1, !is.na(MHQ1.BPDI) & MHQ1.BPDI == 1, useNA="a")))
...
print(with(Full_Data_MHQ2_Table_6[Full_Data_MHQ2_Table_6$MHQ2.Sex == "Male", ], table(!is.na(MHQ2.BD1) & MHQ2.BD1 == 1, !is.na(MHQ1.BPDI) & MHQ1.BPDI == 1, useNA="a")))
...
cat("## Self Harm\n")
cat("# MHQ2 (Rows) vs MHQ1 (Columns)\n")
print(with(Full_Data_MHQ2_Table_6, table(!is.na(MHQ2.SelfHarmEver) & MHQ2.SelfHarmEver == 1, !is.na(MHQ1.MHQ2.SelfHarmEver) & MHQ1.MHQ2.SelfHarmEver == 1, useNA="a")))

print(
  with(
    Full_Data_MHQ2_Table_6[
      !is.na(Full_Data_MHQ2_Table_6$MHQ2.SelfHarmEver) &
	Full_Data_MHQ2_Table_6$MHQ2.SelfHarmEver == 1 &
	(
	  is.na(Full_Data_MHQ2_Table_6$MHQ1.MHQ2.SelfHarmEver) |
	  (
	    !is.na(Full_Data_MHQ2_Table_6$MHQ1.MHQ2.SelfHarmEver) &
	      Full_Data_MHQ2_Table_6$MHQ1.MHQ2.SelfHarmEver == 0
	  )
	),
    ],
    table(IncidentHarm, useNA="a")
  )
)

cat("# Female\n")

print(with(Full_Data_MHQ2_Table_6[Full_Data_MHQ2_Table_6$MHQ2.Sex == "Female", ], table(!is.na(MHQ2.SelfHarmEver) & MHQ2.SelfHarmEver == 1, !is.na(MHQ1.MHQ2.SelfHarmEver) & MHQ1.MHQ2.SelfHarmEver == 1, useNA="a")))
...
print(with(Full_Data_MHQ2_Table_6[Full_Data_MHQ2_Table_6$MHQ2.Sex == "Male", ], table(!is.na(MHQ2.SelfHarmEver) & MHQ2.SelfHarmEver == 1, !is.na(MHQ1.MHQ2.SelfHarmEver) & MHQ1.MHQ2.SelfHarmEver == 1, useNA="a")))
...
cat("## Cannabis\n")
cat("# MHQ2 (Rows) vs MHQ1 (Columns)\n")
print(with(Full_Data_MHQ2_Table_6, table(!is.na(MHQ2.CannabisUseEver) & MHQ2.CannabisUseEver == 1, !is.na(MHQ1.Cannabis.Ever) & MHQ1.Cannabis.Ever == 1, useNA="a")))

print(
  with(
    Full_Data_MHQ2_Table_6[
      !is.na(Full_Data_MHQ2_Table_6$MHQ2.CannabisUseEver) &
	Full_Data_MHQ2_Table_6$MHQ2.CannabisUseEver == 1 &
	(
	  is.na(Full_Data_MHQ2_Table_6$MHQ1.Cannabis.Ever) |
	  (
	    !is.na(Full_Data_MHQ2_Table_6$MHQ1.Cannabis.Ever) &
	      Full_Data_MHQ2_Table_6$MHQ1.Cannabis.Ever == 0
	  )
	),
    ],
    table(IncidentCannabis, useNA="a")
  )
)

cat("# Female\n")

print(with(Full_Data_MHQ2_Table_6[Full_Data_MHQ2_Table_6$MHQ2.Sex == "Female", ], table(!is.na(MHQ2.CannabisUseEver) & MHQ2.CannabisUseEver == 1, !is.na(MHQ1.Cannabis.Ever) & MHQ1.Cannabis.Ever == 1, useNA="a")))
...
print(with(Full_Data_MHQ2_Table_6[Full_Data_MHQ2_Table_6$MHQ2.Sex == "Male", ], table(!is.na(MHQ2.CannabisUseEver) & MHQ2.CannabisUseEver == 1, !is.na(MHQ1.Cannabis.Ever) & MHQ1.Cannabis.Ever == 1, useNA="a")))
...
cat("## SR Diagnosis\n")
cat("# MHQ2 (Rows) vs MHQ1 (Columns)\n")
print(with(Full_Data_MHQ2_Table_6, table(!is.na(MHQ2.SelfReportedDiagnosisMHQ2016Compatible) & MHQ2.SelfReportedDiagnosisMHQ2016Compatible == 1, !is.na(MHQ1.NoSRConditions) & MHQ1.NoSRConditions == 0, useNA="a")))

cat("# Female\n")
print(with(Full_Data_MHQ2_Table_6[Full_Data_MHQ2_Table_6$MHQ2.Sex == "Female", ], table(!is.na(MHQ2.SelfReportedDiagnosisMHQ2016Compatible) & MHQ2.SelfReportedDiagnosisMHQ2016Compatible == 1, !is.na(MHQ1.NoSRConditions) & MHQ1.NoSRConditions == 0, useNA="a")))

cat("# Male\n")
print(with(Full_Data_MHQ2_Table_6[Full_Data_MHQ2_Table_6$MHQ2.Sex == "Male",], table(!is.na(MHQ2.SelfReportedDiagnosisMHQ2016Compatible) & MHQ2.SelfReportedDiagnosisMHQ2016Compatible == 1, !is.na(MHQ1.NoSRConditions) & MHQ1.NoSRConditions == 0, useNA="a")))
