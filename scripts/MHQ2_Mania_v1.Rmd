...
MHQ2$Total.Manifestations<-with(MHQ2, ifelse(!is.na(X29051.0.1) & X29051.0.1 > 0, Total.Manifestations + 1, Total.Manifestations))
MHQ2$Total.Manifestations<-with(MHQ2, ifelse(!is.na(X29051.0.2) & X29051.0.2 > 0, Total.Manifestations + 1, Total.Manifestations))
MHQ2$Total.Manifestations<-with(MHQ2, ifelse(!is.na(X29051.0.3) & X29051.0.3 > 0, Total.Manifestations + 1, Total.Manifestations))
MHQ2$Total.Manifestations<-with(MHQ2, ifelse(!is.na(X29051.0.4) & X29051.0.4 > 0, Total.Manifestations + 1, Total.Manifestations))
MHQ2$Total.Manifestations<-with(MHQ2, ifelse(!is.na(X29051.0.5) & X29051.0.5 > 0, Total.Manifestations + 1, Total.Manifestations))
MHQ2$Total.Manifestations<-with(MHQ2, ifelse(!is.na(X29051.0.6) & X29051.0.6 > 0, Total.Manifestations + 1, Total.Manifestations))
MHQ2$Total.Manifestations<-with(MHQ2, ifelse(!is.na(X29051.0.7) & X29051.0.7 > 0, Total.Manifestations + 1, Total.Manifestations))
```

```{r}
MHQ2$Hypomania.Ever <- with(MHQ2, 
  ifelse(
    (!is.na(X29049.0.0) & X29049.0.0 == 1 | (!is.na(X29050.0.0) & X29050.0.0 == 1)) &
    (X29049.0.0 == 1 & Total.Manifestations >= 3) &
    !is.na(X29052.0.0) & X29052.0.0 == 3,
    1,
    0
  )
)
...
MHQ2$Mania.Ever <- with(MHQ2, 
  ifelse(
    ((!is.na(X29049.0.0) & X29049.0.0 == 1) | (!is.na(X29050.0.0) & X29050.0.0 == 1)) &
    (X29049.0.0 == 1 & Total.Manifestations >= 3) &
    ((!is.na(X29052.0.0) & X29052.0.0 == 3) & ((!is.na(X29056.0.0) & X29056.0.0 == 1) | (!is.na(X29057.0.0) & X29057.0.0 == 1))),
    1,
    0
  )
)
