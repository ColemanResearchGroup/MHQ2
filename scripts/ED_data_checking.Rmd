...
```{r Read in data}
dat <- readRDS("/Users/christopherhuebel/work/raw_data/dat_Anonymous.rds")
```
...
2	Only at time(s) when I was not at low weight
-4	Not applicable, as did not have low weight
-3	Prefer not to answer
