...
dat$SelfReportedDiagnosis <- grep_reports(
  data = dat[, grep("^29000-", colnames(dat))],
  codes = c(1:13, 15:20)
)
...
dat$SelfReportedDiagnosisMHQ2016Compatible <- grep_reports(
  data = dat[, grep("^29000-", colnames(dat))],
  codes = c(1:15, 17, 19)
)
...
dat$SelfReportedAnxietyDisorder <- grep_reports(
  data = dat[, grep("^29000-", colnames(dat))],
  codes = c(10:13, 15)
)
