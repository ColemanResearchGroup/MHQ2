...
dat <- dat %>%
  mutate(Binge_eating_disorder =
        ...
        # "During these episodes of excessive overeating/binge eating, have you:" (Participant needs at least 3 of 5 binge-eating-related characteristics, sum score calculated above)
